...
\title{Radial Velocity Reconnaisance of the M~Dwarf Radio Source GJ\,1151}
...
\begin{abstract}
The recent detection of circularly polarized, variable low-frequency radio emission from the M~dwarf GJ\,1151 has been interpreted as a Jupiter-like electron cyclotron maser instability arising from star-planet interaction. The existence or parameters of the proposed planets have not been determined. In order to search for any planets or binary companions, we have obtained new HARPS-N observations
