...
\begin{abstract}
The recent detection of circularly polarized, variable low-frequency radio emission from the M4.5~dwarf GJ\,1151 has been interpreted as a Jupiter-like electron cyclotron maser instability arising from a star-planet interaction. The existence or parameters of the proposed planets have not been determined. In order to search for any planets or binary companions, we have obtained new HARPS-N observations
...
Exoplanet science has flourished over the last three decades. The number of known planets has doubled nearly every two years since 1995 \citep{Mamajek2016} and this accelerating rate of discovery is projected to continue for at least the next decade if current and upcoming space-based surveys deliver their expected results. However, despite extensive searches \citep[e.g.][]{2000ApJ...545.1058B,2013A&A...552A..65L,Lynch18}, neither exoplanets nor their host stars have been detected at radio frequencies, as the quiescent emission of such systems has been too faint for current telescopes \textcolor{red}{JRC - Not clear what you mean by quiescent here? E.g. Is ECMI quiescent emission?}. But as the Square Kilometre Array \citep[SKA;][]{2009IEEEP..97.1482D} and its precursors, in particular LOFAR \citep[the LOw-Frequency ARray:][]{lofar} come online \textcolor{red}{JRC - LOFAR has been operating for a decade, is not ``coming online''. I would drop the mention of SKA and just say LOFAR, an SKA-precursor, is unparalleled sensitivity at 150 MHz  where detections of such interaction are now possible and cite Zarka et al. (his scaling work)}, the orders-of-magnitude increase in sensitivity and survey speed they provide makes the detection of nearby stars and planets a realistic prospect \citep{pope19}. 
