...
\citet{2019arXiv190505900H} using \kepler estimate that M3-M5 dwarfs host $1.19^{+0.70}_{−0.49}$ planets per star with radii from $0.5-2.5 R_\oplus$ and periods $\in [0.5,10]$\,d, the detection of a planet is actually less important than the exclusion of \emph{non}-planetary models, such as emission from a stellar binary interaction.
